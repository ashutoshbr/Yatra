...
//     var response = await Dio().get('http://10.0.2.2:8000/user/profile', options: 
//         Options( headers: {
...
//     print(jsonData);
//     currentUser user = currentUser(jsonData["email"], jsonData["username"]);
//     return user;
...
//           if(snapshot.hasData) {
//             var user = snapshot.data as currentUser;
//             return ListView(
//               children: [
//               Container(
